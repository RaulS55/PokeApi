    ...
    return CupertinoFormSection.insetGrouped(
      ...
      children: [
        CupertinoFormRow(
          ...
          child: Text(pokemon.id.toString(), style: MyStyle.normal),
        ),
        CupertinoFormRow(
          prefix: const Text("Nombre:"),
          child: Text(pokemon.name.toString(), style: MyStyle.normal),
        ),
        CupertinoFormRow(
        ...
        CupertinoFormRow(
          prefix: const Text("Stats Base:"),
          child:
              Text(pokemon.stats[0].baseStat.toString(), style: MyStyle.normal),
        ),
      ],
    );
  }
